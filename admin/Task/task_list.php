					...
					<tr>
						...
						<td class="text-center">
							<?php
							  ...
							  }elseif($stat[$row['pstatus']] =='Inicio'){
							  ...
							  }elseif($stat[$row['pstatus']] =='Retrasado'){
						...
						<td class="text-center">
							<button type="button" class="btn btn-primary btn-sm btn-flat border-info wave-effect text-while dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
		                      Acción
		                    </button>
			                    <div class="dropdown-menu" style="">
			                      <a class="dropdown-item new_productivity" data-pid = '<?php echo $row['pid'] ?>' data-tid = '<?php echo $row['id'] ?>'  data-task = '<?php echo ucwords($row['task']) ?>'  href="javascript:void(0)"> Añadir Avance</a>
								</div>
						</td>
					</tr>	
				<?php endwhile; ?>
